...
// All the rows the START menu's frame leaves room for: the window starts at row
// 1 and the frame takes rows 0 and 19, so 18 tiles is the lot.
#define MAX_START_MENU_HEIGHT 18
