...
extern const u8 gText_EncounterFossil[];
extern const u8 gText_EncounterStatic[];
extern const u8 gText_EncounterGift[];
extern const u8 gText_EncounterTrade[];
...
extern const u8 gText_KeySystem[];
extern const u8 gText_ExpModifier[];
extern const u8 gText_InfiniteRareCandy[];
extern const u8 gText_InfiniteTMs[];
extern const u8 gText_NoFlash[];
extern const u8 gText_ExpModifier0x[];
extern const u8 gText_ExpModifierHalf[];
extern const u8 gText_ExpModifier1x[];
extern const u8 gText_ExpModifier2x[];
extern const u8 gText_ExpModifier5x[];
extern const u8 gText_NuzlockeRules[];
extern const u8 gText_ShinyClause[];
extern const u8 gText_WhiteOut[];
extern const u8 gText_BattleMode[];
extern const u8 gText_BagItems[];
extern const u8 gText_LevelCaps[];
extern const u8 gText_NuzlockeStart[];
extern const u8 gText_WhiteOutEndRun[];
extern const u8 gText_WhiteOutContinue[];
extern const u8 gText_BagItemsAllowed[];
extern const u8 gText_BagItemsBanned[];
