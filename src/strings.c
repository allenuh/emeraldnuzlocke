...
const u8 gText_NuzlockeRunOver[] = _("Your journey has ended here.\nThis save can't be continued.");
...
const u8 gText_NicknameHatchPrompt[] = _("The newly hatched {STR_VAR_1} is yours\nnow. Give it a name!");
...
const u8 gText_NoFlash[] = _("NO FLASH");
...
const u8 gText_EncounterFossil[] = _("FOSSIL");
const u8 gText_EncounterStatic[] = _("STATIC");
const u8 gText_EncounterGift[] = _("GIFT");
const u8 gText_EncounterTrade[] = _("TRADE");
